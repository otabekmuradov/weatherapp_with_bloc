...
class SecondScreenDetailedWidget extends StatelessWidget {
  const SecondScreenDetailedWidget({super.key});
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${state.fetchWeatherSevenDaysByLoc.list?[1].speed?.round()}km/h',
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${state.fetchWeatherSevenDaysByLoc.list?[1].humidity?.round()}%',
                          style: GoogleFonts.poppins(
                            fontSize: 18,
